...
| Base Document Class | `references/base-document.md` | When creating entity classes, designing BaseDoc, configuring ID generation + auditing + optional version/deleted |
...
| Spring Data Rules | `references/spring-data-rules.md` | When writing Repository interfaces, using @Transactional, mapping annotations, MongoTemplate |
...
Read `references/base-document.md` -> extend BaseDoc -> configure Snowflake ID generator -> enable auditing -> add version/deleted as needed.
...
Read `references/spring-data-rules.md` -> verify Repository patterns -> check mapping annotations -> use audit listeners -> apply lifecycle hooks.
